...
<button
type="submit"
className="border mt-7 w-full p-4 bg-red-600 text-white text-2xl font-medium rounded-lg"
>
ورود
</button>
</form>
...
ورود شما به معنای پذیرش <Link href="/login/terms"  className=" text-green-600 font-medium">شرایط ویتسل </Link> و <Link href="/login/privacy"  className=" text-green-600 font-medium">قوانین حریم خصوصی </Link> است
</div>
</div>
</div>
</>
