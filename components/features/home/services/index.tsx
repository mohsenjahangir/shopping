    ...
    <>
      <div className="  grid grid-cols-4  lg:grid-cols-8   ">
        ...
        <div className="   text-center flex flex-col items-center mt-5  ">
          <img
            className=" w-14"
            src="https://dkstatics-public.digikala.com/digikala-bellatrix/d3ef1e7e6dd2189d4c1468c8998b24b4ec5bcc45_1683402274.png"
            alt=""
          />
        ...
        <div className="   text-center flex flex-col items-center mt-5  ">
          <div className=" bg-slate-100 flex justify-center rounded-full px-5 pb-5  pt-3">
            ...
          </div>
